...
CPos pos = FORTRESS.getInRegion(seed, rPos.getX(), rPos.getZ(), rand);
			// If position null (non existence) or  the position is NOT equal to a fortress 
if (pos == null || !pos.equals(fortress)) {
//discard 
        return false;
			}
		}
		//if valid return True, save 
		return true;
	}
...
//New biome object, with the data from the dimension (Nether) and the Version (MC 1.17)           //testing for seed 
